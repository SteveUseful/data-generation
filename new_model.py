...
# Load the dataset
df = pd.read_csv('C:/dev/Output/Churn_Data2.csv')

# Drop 'CustomerID' as it should not be used for model training
df.drop(['CustomerID'], axis=1, inplace=True)

# Identify categorical and numerical features
categorical_features = ['CustomerEducationLevel', 'ContractRenewal']  # Add other categorical features here
numerical_features = ['CustomerAge', 'CustomerIncome', 'SupportInteraction', 
                      'SatisfactionScore', 'UsageFrequency', 'FeatureUsageScore', 
                      'AccountLifetime', 'MonthlyCharges']  # Add other numerical features here
